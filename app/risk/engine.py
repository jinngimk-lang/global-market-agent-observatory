...
from app.domain.models import OrderIntent, PortfolioSnapshot, RiskDecision, RiskLimits, Side
...
class RiskEngine:
    ...
    def evaluate(self, intent: OrderIntent, portfolio: PortfolioSnapshot) -> RiskDecision:
        ...
        projected_gross = other_exposure + abs(projected_quantity * reference_price)
